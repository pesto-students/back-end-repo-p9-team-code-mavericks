...
const { handleGetFollowingsList, handleGetUserIdByUsername, handleIsFollowing, handleGetUserIdByEmail, handleFollowUser, handleLoggedInUser, handleUserLogout, handleGetFollowersList, handleGetBookmarkList } = require('../controllers/user');
